...
guess_form.addEventListener("submit", (event) => {
    ...
    socket.emit("guess", {
        guess: DOMPurify.sanitize(document.getElementById("guessWord").value),
        passcode: DOMPurify.sanitize(gameId),
    });
...
socket.on("updateGamestate", (state) => {
    ...
    if (gamestate.winner !== null) {
        leftPanel.remove();
        document.getElementById("gameFinishedDisplay").innerHTML = `
